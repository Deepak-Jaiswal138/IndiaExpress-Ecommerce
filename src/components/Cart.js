            ...
            <div className="cart-details" style={{marginTop:'100px'}}>
                {
                    ...
                    shoppingCart.map(cart=>(
                            <div className="cart" key={cart.id}>
                                <span className="cart-image">
                                    <img src={cart.image} alt="Image not found"/>
                                </span>
                    ...
                    :'Sorry your cart currenty emplty'
                }
            </div>
            {shoppingCart.length>0 ? <div className="cart-summary">
                 <div className="summary">
                     ...
                     <div className="stripe-section">
                         <StripeCheckout 
                         stripeKey="pk_test_51JSMffSA1twSh69peyX6zPzYKzeeoS3sCsHRkVSgVzmMAmXAwbgaxUoOi8ntPJcqQrj7ZktAhDWSmmH2CoKdCJhT004K8lAjpl"
                         token={handleToken}
                         billingAddress
                         shippingAddress
